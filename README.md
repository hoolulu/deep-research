...
这个 skill 走完 **4 层流程**才交报告。不是搜完就出，是析→搜+验→写→再验。
...
| --------------------- | ----------- | --------- | ---------------- | ---------- |
| `/research 主题`        | standard 默认 | 8 段/章     | 5,000 字         | ~6–10 min  |
| `/research 主题 -quick` | 快速洞察        | 5 段/章     | 3,000 字         | ~5–8 min   |
| `/research 主题 -deep`  | 极致深度        | 10 段/章    | 10,000 字        | ~12–18 min |
